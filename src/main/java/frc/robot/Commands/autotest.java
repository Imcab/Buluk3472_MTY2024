...
public class autotest extends Command{
    ...
    public autotest(DriveMecos mecanum, subpos posoutake, subintake intake, suboutake moutake, subposintake posintake){
    ...
    public void execute(){
       ...
       else if (mytime >= 10.3&& mytime <12.4){ //cambiar
          mecanum.mecanumauto(0.0, 0.0, 0.0, 0.0);
          posintake.vel(0);
          intake.velocities(.8);
       }
       else if (mytime >= 12.4&& mytime <13.4){
          mecanum.tankauto(0.31, 0.3);
          intake.velocities(0.8);
       }
       else if  (mytime >= 13.6&& mytime <13.8){
          mecanum.tankauto(-0.31, -0.3);
       ...
       else if  (mytime >= 13.9&& mytime <16.2){
          intake.velocities(0);
          posintake.autoreintake();
          mecanum.mecanumauto(0.3, -0.31, -0.3, 0.31);
          posoutake.position_outake(21);
          moutake.setoutakespeed(1);
       }
       else if (mytime >= 16.2&& mytime <16.6){
          posoutake.setposspeed(0);
          posintake.vel(0);
          intake.velocities(-1);
       }
