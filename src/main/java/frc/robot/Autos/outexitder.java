...
public class outexitder extends Command{
    ...
    public outexitder(subintake intake, suboutake outake, DriveMecos chasis, limelight autolimelight, suboutakeposicion outpos){
        this.intake = intake;
        this.outake = outake;
        this.chasis = chasis;
